            ...
            <div className="results-section">
                ...
                <div className="result-and-title">
                    ...
                    (<div className="result-box" id="ripe-details">
                        ...
                        <div className="metric"><span title='The poll interval used by the probe during the measurement'>Poll interval</span><span>{ripeData?.measurementData.poll ? `${ripeData.measurementData.poll} s` : 'N/A'}</span></div>
